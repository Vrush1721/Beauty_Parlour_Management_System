	...
	<div class="appbody">
		<center>
			...
			<div class="coursecontainer">
				<form class="appi-form" method="post" action="../addcourse"
					...
					<input type="hidden" name="idcourse"> <br> <label
						class="label">Course Name</label><br> <input type="text"
						name="cname" required><br> <br> <label
						class="label">Course Type</label><br> <select type="text"
						name="ctype" style="width: 290px; height: 38px;">
					...
					<br> <label class="label">Price</label><br> <input
						type="text" name="cprice" required><br>
					<br> <label class="label">Photo</label><br> <input
						type="file" name="photo" required><br>
					<br> <label class="label">Course Details</label><br> <input
						type="text" name="cdetails" style="width: 290px; height: 60px;"><br>
					<br>
